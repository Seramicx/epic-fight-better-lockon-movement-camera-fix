...
**This branch:** Forge 1.20.1 (latest: [v2.1.3](https://github.com/Seramicx/epic-fight-better-lockon-movement-camera-fix/releases/latest))
**NeoForge 1.21.1:** see the [`1.21.1-neoforge`](https://github.com/Seramicx/epic-fight-better-lockon-movement-camera-fix/tree/1.21.1-neoforge) branch.
...
Camera, mount, ship, and F5 features live in separate mods. Install whichever you want:
...
3. Download the jar from the [latest release](https://github.com/Seramicx/epic-fight-better-lockon-movement-camera-fix/releases/latest).
